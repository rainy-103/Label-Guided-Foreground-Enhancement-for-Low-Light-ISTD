...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default='./visual/', type=str)
    ###LOL
    # parser.add_argument('-dirB', default='../dataset/LOLdataset/eval15/low', type=str)
    ###LOLv2
    parser.add_argument('-dirB', default='/Users/dangjiachen/Desktop/LLIE/dataset/LOLdataset/eval15/high/', type=str)
    # parser.add_argument('-dirB', default='../dataset/LOLv2/Synthetic/Test/high/', type=str)
    #####5k
    # parser.add_argument('-dirB', default='../dataset/MITfivek/test/high', type=str)
    ######SICE
    # parser.add_argument('-dirB', default='../dataset/SICE/test/high_resize', type=str)
    ######VE-LOL
    # parser.add_argument('-dirB', default='../dataset/VE-LOL/test/high', type=str)
    ######VE-LOL-syn
    # parser.add_argument('-dirB', default='../dataset/VE-LOL-L-Syn/VE-LOL-L-Syn-Normal_test', type=str)
    # parser.add_argument('-dirB', default='../dataset/lsrw/eval/Nikon/high', type=str)
    # parser.add_argument('-dirB', default='../dataset/lsrw/eval/Huawei/high', type=str)
    ...
    if len(dirA) > 0 and len(dirB) > 0:
        measure_dirs(dirA, dirB, use_gpu=False, verbose=True)